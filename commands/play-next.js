...
module.exports = {
    data: new SlashCommandBuilder().setName("playnext").setDescription("Adds new song or playlist to next on queue").addStringOption(option =>
        ...
        if (!ytpl.validateID(possibleURL)) {
            ...
            if (validURL) {
                ...
                try {
                    ...
                    return await interaction.followUp({content: "Playing Spotify Playlist Next - " + results.data.name});
                } catch (e) {
                    console.log(e);
