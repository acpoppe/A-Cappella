...
module.exports = {
    data: new SlashCommandBuilder().setName("unpause").setDescription("Unpauses the song"),
    async execute(interaction) {
        ...
        QueueManager.getInstance().unpauseQueue(interaction.guildId, interaction.channel, voiceChannel);

        return await interaction.followUp({content: "Unpaused!"});
    }
};